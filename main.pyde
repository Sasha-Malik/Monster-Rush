...
def setup():
        ...
        imageBackground = loadImage("images/img1.png")
        imageP1 = loadImage("images/platform1.png")
        imageGround = loadImage("images/ground.png")
        imageCh1= loadImage("images/character1.png")
        imageCh2= loadImage("images/character2.png")
        imageM1= loadImage("images/monster1.png")
        imageM2= loadImage("images/monster2.png")
        imageCoin= loadImage("images/coin.png")
        imagePU1= loadImage("images/jumping_powerup.png")
        imageBackground2 = loadImage("images/img2.png")
        imageWIN = loadImage("images/treasure.png")
        imageDoor= loadImage("images/door.png")
        imageLost=loadImage("images/gameover.png")
        imageGAMEWIN=loadImage("images/win.png") 
    
       
        bg_music = player.loadFile("sound/background.mp3")
        bg_music.loop()    
       
        global jump
        jump = player.loadFile("sound/jump.wav")
       
        global die
        die = player.loadFile("sound/die1.mp3")
